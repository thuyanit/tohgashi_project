<div id="dashboard">
    <div id="rental_goods">
        ...
        <table class="parent">
            <?php
            // Get order detail
			$list_products = get_order_detail($current_order->id);
        ...
        <div class="total">
            <?php echo '<span>合計金額</span><span style="font-size: 24px;color: #e74c3c;">'.number_format($current_order->total_price).'円</span>（税抜）'; ?>
        </div>
    </div>
</div>
