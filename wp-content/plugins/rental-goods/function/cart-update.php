            ...
            if ($insert_item_result) {
                ...
                foreach ($item['product_op'] as $k => $val) {
                    ...
                    if ($insert_item_spec_result) {
                        if($val['product_specification']!=''||$val['product_specification']!=null){
                            ...
                            // Product don't have Specification
                            $quantity_stock = $val['qty_stock'] - $val['product_qty'];
                            $update_stock_result = $wpdb->update( 'shop_togashi',
                                array( 'item_number' => $quantity_stock ),
                                array( 'id' => $k ),
                                array( '%d'),
                                array( '%d')
                            );
